        ...
        if cmd == "/help":
            ...
            try:
                ...
                await message.reply_text(
                    ...
                    f"Можно связаться с моим разработчиком через бота @ModeratorX_bot\n"
    ...
    try:
        ...
        if not creator:
            ...
            await message.reply_text(
                ...
                "Связаться с разработчиком можно через @ModeratorX_bot"
            )
            return
...
def main():
    ...
    application.add_handler(CommandHandler("getrules", rules_command))
